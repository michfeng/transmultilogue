...
if __name__ == '__main__':
    ...
    for e in tqdm(range(n_epochs), desc = 'MOSEI Regression'):
        ...
        print("Train Loss - MOSEI Regression", train_loss)
        print("Test Loss - MOSEI Regression", test_loss)
        print("Train MAE - MOSEI Regression", train_mae)
        print("Test MAE - MOSEI Regression", test_mae)
        print("Train Pearson - MOSEI Regression", train_pear)
        print("Test Pearson - MOSEI Regression", test_pear)
