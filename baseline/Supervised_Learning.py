    ...
    def _trainprocess():
        ...
        for epoch in range(total_epochs):
            ...
            for j in train_dataloader:
                ...
                labels.append(j[-1].detach().cpu().numpy())
            ...
            mae = mean_absolute_error(labels, preds, sample_weight=np.ones((preds.shape)))
            
            print("Epoch "+str(epoch)+" train loss: "+str(totalloss/totals) + " train MAE: "+str(mae))
            ...
            if task == "classification":
                ...
                mae = mean_absolute_error(true, pred, sample_weight=np.ones((true.shape)))
                print("Epoch "+str(epoch)+" valid loss: "+str(valloss.item()) + " valid MAE: "+str(mae))
